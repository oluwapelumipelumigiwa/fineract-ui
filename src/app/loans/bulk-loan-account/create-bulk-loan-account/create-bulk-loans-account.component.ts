 ...
 */
@Component({
  selector: 'mifosx-create-bulk-loans-account',
  templateUrl: './create-bulk-loans-account.component.html',
  styleUrls: ['./create-bulk-loans-account.component.scss']
})
export class CreateBulkLoansAccountComponent implements OnInit {
