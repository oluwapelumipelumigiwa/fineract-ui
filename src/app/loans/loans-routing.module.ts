...
import { CreateBulkLoansAccountComponent } from './bulk-loan-account/create-bulk-loan-account/create-bulk-loans-account.component';
/** Custom Resolvers */
...
import { BulkAccountComponent } from './bulk-account/bulk-account.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'create',
        data: { title: 'Create Bulk Application', breadcrumb: 'Create Bulk Application' },
      ...
      // {
      //   path: ':bulkId',
      //   data: { title: 'Bulk Account View', routeParamBreadcrumb: 'savingAccountId' },
      //   component: GlimAccountComponent,
      //   resolve: {
      //     glimData: GLIMViewResolver,
      //     groupsData: GroupAccountsResolver
